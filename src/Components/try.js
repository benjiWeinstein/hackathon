    ...
    <FactoryRoot>
      ...
      <FlexColumn>
        ...
        <FlexRow>
            ...
            <Com title={`Streetwear TLV`} src={`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSwEH7T13VYfoLZz-0PdlHB-9JFXLypnHLfuA&usqp=CAU`} descrip={`Can you catch up with the city?`}></Com>
        ...
        <FlexRow>
            <Com title={`skateboard`} src={`https://www.liveabout.com/thmb/XZZCqjrbkW-CfaUHDHN6jPEdAI8=/2715x2715/smart/filters:no_upscale()/man-on-skateboard-in-mid-air-114997351-5a29a61822fa3a0037fac8a4.jpg`} descrip={`Skate in style, be with style.`}></Com>
        ...
        <FlexRow>
            <Com title={`Cocktail party`} src={`https://www.beyoung.in/blog/wp-content/uploads/2018/11/wirh-accessories.jpg`} descrip={`We can also recommend actual cocktails`}></Com>
            ...
            <Com title={`Weddings in Tel Aviv`} src={`https://target.scene7.com/is/image/Target/GUEST_0e1b6b3e-274c-4c3b-a01e-e0de0a1a646a?wid=1000&hei=1000`} descrip={`Dress like you really want.`}></Com>   
        </FlexRow>
      </FlexColumn>
    </FactoryRoot>
  );
